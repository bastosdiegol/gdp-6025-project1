...
MyOtherMatrix::MyOtherMatrix(unsigned int rows, unsigned int columns) {
...
MyOtherMatrix::MyOtherMatrix(unsigned int rows, unsigned int columns, float value) {
	// Set values for rows and columns
	this->rows = rows;
	this->columns = columns;
...
MyOtherMatrix::MyOtherMatrix(std::vector< std::vector<float> > newValues) {
	// Set values for rows and columns
...
MyOtherMatrix::MyOtherMatrix(const MyOtherMatrix& rhs) {
...
void MyOtherMatrix::printMatrix() {
